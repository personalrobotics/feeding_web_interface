...
const Home = () => {
    ...
    async function generateContent(currState) {
        return (
            <div>
            ...
            <>
                <div>
                    ...
                    <Row xs={1} md={1} className="justify-content-center mx-2 my-2">
                        <Button variant="primary" size="lg" className="btn-huge" id="#startBtn" onClick={function () {
                            changeState(constants.States[1]);
                        }} style={{ width: "75%" }}>Start Feeding</Button>
                    </Row>
