    ...
    if (currentStateVal.feeding_status == constants.States[7] || currentStateVal.feeding_status == constants.States[8]) {
        return (
            <div>
                ...
                <Row xs={3} md={2} className="justify-content-center mx-2 my-2">
                    <Button variant="primary" className="mx-2 mb-2" size="lg" onClick={function () {
        ...
        return (
            <div>
                <h1 className=" text-center">Moving above the Plate</h1>
        ...
        return (
            <div>
                <h1 className="text-center">Select a food item</h1>
                <Row xs={3} md={4} className="justify-content-center mx-1 my-2">
                    {food.map((value, i) => (
                        <Button variant="primary" className="mx-2 mb-2" size="lg" onClick={function () {
        ...
        return (
            <div>
                <h1 className=" text-center">Acquiring the selected food</h1>
        ...
        return (
            <div>
                <h1 className=" text-center">Click when ready for a bite</h1>
        ...
        return (
            <div>
                <h1 className=" text-center">Moving closer to your mouth</h1>
        ...
        return (
            <div>
                <h1 className=" text-center">Click when you are done with your bite</h1>
