...
def generate_launch_description():
  ...
  ld.add_action(
      IncludeLaunchDescription(
          ...
          launch_arguments = {'run_web_bridge': "false", 
          'run_food_detection': "false", 'run_face_detection': "false", 
          'run_motion': "false", 'run_real_sense': "true"}.items()
      )
  )

  # Add Request
  request_path = {
        "request_path": ParameterValue(PathJoinSubstitution([package_prefix, "..", "data", request]), value_type=str)
  }
